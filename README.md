...
I am an AI/ML research engineer working in precision oncology and bioinformatics, currently AI (Life Sciences) Lead at [BIO4 Campus](https://bio4campus.rs) in Belgrade, where I lead AI/ML strategy and build computational infrastructure for genomics and clinical machine learning. In parallel I am an ML Engineer in the field of bioinformatics. Ex-intern at [Microsoft](https://www.microsoft.com/). I hold an MPhil in Advanced Computer Science from the [University of Cambridge](https://www.postgraduate.study.cam.ac.uk/courses/directory/cscsmpacs), where I worked with prof.[Pietro Lio](https://www.cst.cam.ac.uk/people/pl219) and the [Wellcome Sanger Institute](https://www.sanger.ac.uk/) on graph neural networks for single-cell multiomics. Before Cambridge, I completed an MSc in Data Science specialising in computational biology. My current work is in tumour growth modelling, deep learning solvers for brain tumour dynamics, and digital twins for CNS malignancies.
